...
namespace MyCompanyName.AbpZeroTemplate.Maui.Core.Extensions
{
    public static class AbpUserLocalizationConfigDtoExtensions
    {
        ...
        {
            return Localize(userLocalizationConfig, key, MyCompanyName.AbpZeroTemplateConsts.LocalizationSourceName, args);
        }
    }
}
