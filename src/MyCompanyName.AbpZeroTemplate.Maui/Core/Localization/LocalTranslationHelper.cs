...
namespace MyCompanyName.AbpZeroTemplate.Maui.Core.Localization
{
    public static class LocalTranslationHelper
    {
        private const string ResourceId = "MyCompanyName.AbpZeroTemplate.Localization.Resources.LocalTranslation";
