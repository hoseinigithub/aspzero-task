...
using MyCompanyName.AbpZeroTemplate.Maui.Services.Tenants;
using MyCompanyName.AbpZeroTemplate.Maui.Services.UI;
using Plugin.Connectivity;

#if ANDROID
using MyCompanyName.AbpZeroTemplate.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using MyCompanyName.AbpZeroTemplate.Maui.Core.Platforms.iOS.HttpClient;
#endif
