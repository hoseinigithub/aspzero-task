(function () {
  $(function () {
    ...
    function toggleSmtpCredentialFormGroups() {
      if ($('#Settings_SmtpSmtpUseAuthentication').is(':checked')) {
    ...
    $('#Settings_SmtpSmtpUseAuthentication').change(function () {
    ...
    //Appearance/Logo
    $('#SettingsLightLogoMinimalUploadForm').ajaxForm({
      beforeSubmit: function () {
        var $fileInput = $('#SettingsLightLogoMinimalUploadForm input[name=ApplicationLogoImage]');
        beforeSubmit($fileInput);
      },
      success: function (response) {
        if (response.success) {
    ...
    $('#SettingsDarkLogoMinimalUploadForm').ajaxForm({
      beforeSubmit: function () {
        var $fileInput = $('#SettingsDarkLogoMinimalUploadForm input[name=ApplicationLogoImage]');
        beforeSubmit($fileInput);
      },
      success: function (response) {
        if (response.success) {
    ...
    function beforeSubmit(fileInput) {
