...
(function () {
  ...
  function startConnection(url, configureConnection) {
    ...
    return (function start(transport) {
      ...
      var connection = new signalR.HubConnectionBuilder().withUrl(url, transport).build();
      ...
      return connection
        ...
        .catch(function (error) {
          abp.log.debug(
            'Cannot start the connection using ' + signalR.HttpTransportType[transport] + ' transport. ' + error.message
          );
